import { useCreateMedication, useDeleteMedication, useGetMedication, useListMedications, useReplaceMedication, useUpdateMedication } from "../api/medication.queries"
...
export const useMedicationDomain = (medication_id?: string) => {
    ...
    return {
        ...
        flags: {
            ...
            isActionInFlight: createPending || updatePending || replacePending || deletePending,
        },

        actions: {
            addMedication: (body: any) => createMutation(body),
            modifyMedication: (medication_id: string, body: any) => updateMutation({ medication_id, body }),
            replaceMedication: (medication_id: string, body: any) => replaceMutation({ medication_id, body }),
            removeMedication: (medication_id: string) => deleteMutation(medication_id)
